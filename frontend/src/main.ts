...
function landing() {
  ...
  app.innerHTML = `${header()}<main id="main" class="route-enter">
    ...
    <section class="section" aria-labelledby="paid-title"><div class="wrap privacy-grid"><div><h2 id="paid-title">Family edition: eight-turn rooms</h2><p class="price-line">$6 once</p><p>Eight-turn rooms are included. Core four-turn play and PNG downloads stay free.</p><a class="button primary" href="https://api.sociobot.in/api/v1/products/family-doodle-relay/checkout">Buy the family edition</a><p class="muted">One-time purchase. Sociobot is the merchant of record.</p></div>
